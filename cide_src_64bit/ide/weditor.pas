...
const
      ...
      efSyntaxHighlight     = $00000040;              // $00000040
   ...
   @info, mfInsertInApp+ mfInformation + mfYesNoCancel);
    edSaveAs,edWriteBlock,edReadBlock:
      begin
        ...
        Re:=Application^.ExecuteDialog(New(PFileDialog, Init('*.c;*.cpp;*.h',

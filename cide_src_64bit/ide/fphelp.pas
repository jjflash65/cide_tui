...
{$endif}
      ...
      hint_target            = '';
      hint_primaryfile       = '';
      hint_clearprimaryfile  = '';
      hint_information       = '';
      hint_showmessages      = '';
      hint_debugmenu         = '';
      hint_togglebreakpoint  = '';
      hint_createnewbreakpoint = '';
      hint_editbreakpoint    = '';
      hint_deletebreakpoint  = '';
      hint_opengdbwindow     = '';
      hint_addwatch          = '';
      hint_watches           = '';
      hint_callstack         = '';
      hint_editbreakpoints   = '';
      hint_toolsmenu         = '';
      hint_calculator        = '';
      hint_grep              = '';
      hint_gotosource        = '';
      ...
      hint_directories       = '';
      hint_browser           = '';
      hint_reloadmodifiedfile= '';
      hint_tools             = '';
      hint_environmentmenu   = '';
      hint_preferences       = '';
      hint_editoroptions     = '';
      hint_codecomplete      = '';
      hint_codetemplates     = '';
      ...
      hint_closewindow       = '';
      hint_windowlist        = '';
      hint_userscreenwindow  = '';
      hint_helpmenu          = '';
      hint_helpcontents      = '';
      hint_helpindex         = '';
      hint_helptopicsearch   = '';
      hint_helpprevtopic     = '';
      hint_helphowtouse      = '';
      hint_helpfiles         = '';
      hint_openatcursor      = '';
      hint_browseatcursor    = '';
      hint_editoroptionscur  = '';
      hint_rawgdbwindow      = '';
      hint_disassemblywindow = '';
      hint_allbreakpoints    = '';

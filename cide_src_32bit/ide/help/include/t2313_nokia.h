/* -------------------- T2313_NOKIA.H -------------------------
...
#ifndef in_t2313_nokia
  #define in_t2313_nokia
  ...
  #define fullascii                             // ASCII Zeichensatz wird auch mit
    ...
    #define lastascii 96
      ...
      #define LCD_DC_PIN            PB2
      #define LCD_CE_PIN            PB1           //  SS SPI pin

    #else

      #define SPI_DDR               DDRB
      #define SPI_MOSI_PIN          PB1
      #define SPI_CLK_PIN           PB0
      ...
      #define LCD_DC_PIN            PB2
      #define LCD_CE_PIN            PB3

    #endif

  #else

    // Anbindung fuer ATmega MCU
